...
// Utility class meant for compatibility between the Android-x86 version of Remotebar (compiled with SDK 28)
// and the Play Store version of Remotebar (compiled with SDK 34).
