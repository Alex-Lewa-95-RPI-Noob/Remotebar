...
class UTest {
    ...
    fun testGetBaseRemotebarSizeWithSW720dp() {
        PowerMockito.spy(U::class.java)
        ...
        Assert.assertEquals(initialSize, U.getBaseRemotebarSize(context), 0f)
    }

    @Test
    fun testGetBaseRemotebarSizeWithNormalDimension() {
        PowerMockito.spy(U::class.java)
        val isSystemTrayEnabledAnswer = BooleanAnswer()
        PowerMockito.`when`(U.isSystemTrayEnabled(context)).thenAnswer(isSystemTrayEnabledAnswer)
        isSystemTrayEnabledAnswer.answer = false
        ...
        Assert.assertEquals(initialSize + dashboardButtonSize,
                U.getBaseRemotebarSize(context), 0f)
    ...
    fun testWrapContext() {
        ...
        Assert.assertEquals(R.style.Remotebar.toLong(), (themeResource as Int).toLong())
        ...
        Assert.assertNotNull(themeResource)
        Assert.assertEquals(R.style.Remotebar_Dark.toLong(), (themeResource as Int).toLong())
