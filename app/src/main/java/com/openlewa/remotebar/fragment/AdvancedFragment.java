...
public class AdvancedFragment extends SettingsFragment {
        ...
        switch(p.getKey()) {
            ...
            case PREF_SECONDSCREEN:
                ...
                if(packageName == null) {
                    ...
                    intent2.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.openlewa.secondscreen.free"));
                } else
    ...
    private void updateDashboardGridSize(boolean restartRemotebar) {
        ...
        if(restartRemotebar) U.restartRemotebar(getActivity());
    }
}
