...
public class RemotebarPosition {

    private RemotebarPosition() {}
    ...
    public static boolean isVertical(Context context) {
        return isVertical(getRemotebarPosition(context));
    }
    ...
    public static boolean isLeft(Context context) {
        return isLeft(getRemotebarPosition(context));
    }
    ...
    public static boolean isRight(Context context) {
        return isRight(getRemotebarPosition(context));
    }
    ...
    public static boolean isBottom(Context context) {
        return isBottom(getRemotebarPosition(context));
    }
    ...
    public static boolean isVerticalLeft(Context context) {
        return isVerticalLeft(getRemotebarPosition(context));
    }
    ...
    public static boolean isVerticalRight(Context context) {
        return isVerticalRight(getRemotebarPosition(context));
    }

    public static String getRemotebarPosition(Context context) {
    ...
    public static void setCachedRotation(int cachedRotation) {
        RemotebarPosition.cachedRotation = cachedRotation;
    }
}