...
public class Constants {
    ...
    public static final String ACTION_FORCE_REMOTEBAR_RESTART = "com.openlewa.remotebar.FORCE_TASKBAR_RESTART";
    ...
    public static final String ACTION_HIDE_REMOTEBAR = "com.openlewa.remotebar.HIDE_TASKBAR";
    ...
    public static final String ACTION_SHOW_HIDE_REMOTEBAR = "com.openlewa.remotebar.SHOW_HIDE_TASKBAR";
    public static final String ACTION_SHOW_START_MENU_SPACE = "com.openlewa.remotebar.SHOW_START_MENU_SPACE";
    public static final String ACTION_SHOW_REMOTEBAR = "com.openlewa.remotebar.SHOW_TASKBAR";
    ...
    public static final String ACTION_TEMP_HIDE_REMOTEBAR = "com.openlewa.remotebar.TEMP_HIDE_TASKBAR";
    public static final String ACTION_TEMP_SHOW_REMOTEBAR = "com.openlewa.remotebar.TEMP_SHOW_TASKBAR";
    ...
    public static final String PREF_HIDE_REMOTEBAR = "hide_taskbar";
    ...
    public static final String PREF_REMOTEBAR_ACTIVE = "taskbar_active";
