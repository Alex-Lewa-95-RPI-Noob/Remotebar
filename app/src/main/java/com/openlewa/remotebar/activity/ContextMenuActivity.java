...
public class ContextMenuActivity extends PreferenceActivity implements Preference.OnPreferenceClickListener {
    ...
    boolean shouldHideRemotebar = false;
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if(showStartMenu || desktopIcon != null) {
            ...
            switch(RemotebarPosition.getRemotebarPosition(this)) {
            ...
            if(!RemotebarPosition.isVertical(this) && (params.x > display.width / 2))
        ...
        if(U.isChromeOs(this)
                && RemotebarPosition.isBottom(this)) {
