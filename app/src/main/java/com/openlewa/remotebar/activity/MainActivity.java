...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!U.isLibrary(this)) {
            ...
            int lightTheme = isRelaunched ? R.style.Remotebar_Floating : R.style.Remotebar;
            int darkTheme = isRelaunched ? R.style.Remotebar_Dark_Floating : R.style.Remotebar_Dark;
        ...
        if(!isLibrary) {
            ...
            U.setComponentEnabled(this, StartRemotebarActivity.class, true);
    ...
    private void proceedWithAppLaunch(Bundle savedInstanceState) {
        ...
        if(pref.getInt("show_changelog", 0) < latestChangelogVersion
            ...
            snackbar.setAction(R.string.tb_action_view, v -> {
                ...
                Uri uri = Uri.parse("https://github.com/openlewa/Remotebar/blob/" + BuildConfig.VERSION_CODE + "/CHANGELOG.md");
                try {
    ...
    private void startRemotebarService() {
        SharedPreferences pref = U.getSharedPreferences(this);
        SharedPreferences.Editor editor = pref.edit();
