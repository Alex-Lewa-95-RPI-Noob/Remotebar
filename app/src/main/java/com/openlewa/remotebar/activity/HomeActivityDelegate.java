...
public class HomeActivityDelegate extends AppCompatActivity implements UIHost {
    private RemotebarController taskbarController;
    ...
    private boolean forceRemotebarStart = false;
    ...
    private final BroadcastReceiver forceRemotebarStartReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            forceRemotebarStart = true;
        }
    };
    ...
    private void init() {
        if(U.canDrawOverlays(this)) {
            if(!U.canBootToFreeform(this)) {
                ...
                if(forceRemotebarStart) {
                    forceRemotebarStart = false;
    ...
    private void startRemotebar() {
        // Ensure that the freeform hack is started whenever Remotebar starts
        ...
        if(isSecondaryHome) {
            ...
            taskbarController = new RemotebarController(this);
            ...
            // We always start the Remotebar and Start Menu services, even if the app isn't normally running
            try {
    ...
    protected void onDestroy() {
        ...
        U.unregisterReceiver(this, forceRemotebarStartReceiver);
    ...
    private void refreshDesktopIcons() {
        ...
        boolean taskbarIsVertical = RemotebarPosition.isVertical(this);
    ...
    private void updateMargins() {
        ...
        String position = RemotebarPosition.getRemotebarPosition(this);
        int iconSize = getResources().getDimensionPixelSize(R.dimen.tb_icon_size);
