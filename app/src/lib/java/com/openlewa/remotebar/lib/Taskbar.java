...
@Keep public class Remotebar {

    private Remotebar() {}

    /**
     * Opens the settings page for configuring Remotebar.
    ...
    /**
     * Opens the settings page for configuring Remotebar, using the specified title.
     * @param context Context used to start the activity
    ...
    /**
     * Opens the settings page for configuring Remotebar, using the specified theme.
     * @param context Context used to start the activity
    ...
    /**
     * Opens the settings page for configuring Remotebar, using the specified title and theme.
     * @param context Context used to start the activity
     * @param title Title to display in the top level of the settings hierarchy.
     *              If null, defaults to "Settings".
     * @param theme Theme to apply to the settings activity. If set to -1, the activity will
    ...
    /**
     * Enables or disables Remotebar's desktop mode at runtime.
